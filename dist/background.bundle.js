...
// NAMESPACE OBJECT: ./src/background/datahandlers.js
var datahandlers_namespaceObject = {};
__webpack_require__.r(datahandlers_namespaceObject);

;// ./src/background/db.js
var dbName = 'firefoxRecapDB';
var dbVersion = 1;
var db_db;
function initDB() {
  return new Promise(function (resolve, reject) {
    ...
    request.onupgradeneeded = function (event) {
      ...
      if (!db.objectStoreNames.contains('historyItems')) {
        var historyStore = db.createObjectStore('historyItems', {
          keyPath: 'id',
          autoIncrement: true
        });
        ...
        historyStore.createIndex('domain', 'domain', {
          unique: false
        });
      }
      if (!db.objectStoreNames.contains('visitDetails')) {
        var visitsStore = db.createObjectStore('visitDetails', {
          keyPath: 'visitId'
        });
        visitsStore.createIndex('url', 'url', {
          unique: false
        });
        visitsStore.createIndex('visitTime', 'visitTime', {
          unique: false
        });
      }
      // the goal is to store the category of the URL from the firefoxrecap/url-title-classifier
      if (!db.objectStoreNames.contains('categories')) {
        var categoriesStore = db.createObjectStore('categories', {
          keyPath: 'url'
        });
        categoriesStore.createIndex('category', 'category', {
          unique: false
        });
      }
    };
...
function es6_parse(url, options = {}) {
...
var OISD_BLOCKLIST_URL = 'https://big.oisd.nl/domainswild';
var oisdBlocklist = new Set();
var isBlocklistLoaded = false;
var blocklistLoadPromise = null;
function loadBlocklist() {
  return _loadBlocklist.apply(this, arguments);
...
function _loadBlocklist() {
  _loadBlocklist = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return _context2.abrupt("return", blocklistLoadPromise);
        case 2:
          if (!isBlocklistLoaded) {
            _context2.next = 4;
            break;
          }
          return _context2.abrupt("return", Promise.resolve(oisdBlocklist));
        case 4:
          blocklistLoadPromise = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            var response, text, domains;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  _context.prev = 0;
                  console.log("[blacklist] Fetching blocklist from ".concat(OISD_BLOCKLIST_URL, "..."));
                  _context.next = 4;
                  return fetch(OISD_BLOCKLIST_URL);
                case 4:
                ...
                case 9:
                  ...
                  .filter(function (line) {
                    return line && !/^[#!/\s]/.test(line) && /^[a-z0-9.-]+$/.test(line.toLowerCase()) && !/^\d{1,3}(\.\d{1,3}){3}$/.test(line);
                  })
                  ...
                  console.log("[blacklist] Blocklist loaded successfully. ".concat(oisdBlocklist.size, " unique domains processed."));
                  // blocklistLoadPromise = null; // Keep the promise to indicate successful load
                  return _context.abrupt("return", oisdBlocklist);
                case 17:
                  _context.prev = 17;
                  _context.t0 = _context["catch"](0);
                  console.error(' [blacklist] Failed to load or process blocklist:', _context.t0);
 ...
 */
function blacklist_shouldBlockDomain(url) {
  ...
  if (!isBlocklistLoaded && !blocklistLoadPromise) {
    ...
    console.error("[blacklist] Blocklist failed to load or hasn't started. Blocking URL:", url);
    return true;
  }
  try {
    var parsedUrl = new URL(url);
    var hostname = parsedUrl.hostname.toLowerCase(); // Normalize hostname

    // Use tldts to get the effective root domain, also normalized
    var _parse = parse(hostname),
      rootDomain = _parse.domain;
    if (!hostname) {
    ...
    if (rootDomain && rootDomain !== hostname && oisdBlocklist.has(rootDomain)) {
...
;// ./src/background/datahandlers.js
function datahandlers_typeof(o) { "@babel/helpers - typeof"; return datahandlers_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, datahandlers_typeof(o); }
...
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == datahandlers_typeof(i) ? i : i + ""; }
function _toPrimitive(t, r) { if ("object" != datahandlers_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != datahandlers_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
...
function datahandlers_regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ datahandlers_regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == datahandlers_typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator["return"] && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(datahandlers_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, "catch": function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function datahandlers_asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function datahandlers_asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { datahandlers_asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { datahandlers_asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }


// Function to store history items in the database from the history api
function storeHistoryItems(_x) {
  return _storeHistoryItems.apply(this, arguments);
} // Function to store visit details in the database according to the url that it gets
function _storeHistoryItems() {
  _storeHistoryItems = datahandlers_asyncToGenerator(/*#__PURE__*/datahandlers_regeneratorRuntime().mark(function _callee(items) {
    var toStore;
    return datahandlers_regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          toStore = items.filter(function (item) {
            return !shouldBlockDomain(item.url);
          });
          if (!(toStore.length === 0)) {
            _context.next = 4;
            break;
        ...
        case 4:
          return _context.abrupt("return", new Promise(function (resolve, reject) {
            var transaction = db.transaction(['historyItems'], 'readwrite');
            var historyStore = transaction.objectStore('historyItems');
            var successCount = 0;
            toStore.forEach(function (item) {
              var request = historyStore.put({
                url: item.url,
                title: item.title,
            ...
            transaction.oncomplete = function () {
              console.log("Stored ".concat(successCount, " history items"));
            };
...
function storeVisitDetails(_x2, _x3) {
  return _storeVisitDetails.apply(this, arguments);
...
function _storeVisitDetails() {
  _storeVisitDetails = datahandlers_asyncToGenerator(/*#__PURE__*/datahandlers_regeneratorRuntime().mark(function _callee2(url, visits) {
    return datahandlers_regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", new Promise(function (resolve, reject) {
            var transaction = db.transaction(['visitDetails'], 'readwrite');
            var visitsStore = transaction.objectStore('visitDetails');
            var successCount = 0;
            visits.forEach(function (visit) {
              var request = visitsStore.put({
            ...
            transaction.oncomplete = function () {
              console.log("Stored ".concat(successCount, " visit details for ").concat(url));
            };
            transaction.onerror = function (event) {
              console.error('Transaction error:', event.target.error);
              reject(event.target.error);
...
function fetchAndStoreHistory() {
  return _fetchAndStoreHistory.apply(this, arguments);
} // Modified getHistoryFromDB to include timing information based on the ajusted timestamp
function _fetchAndStoreHistory() {
  _fetchAndStoreHistory = datahandlers_asyncToGenerator(/*#__PURE__*/datahandlers_regeneratorRuntime().mark(function _callee3() {
    var days,
      startTime,
      historyItems,
      _iterator,
      ...
      visits,
      _args3 = arguments;
    return datahandlers_regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          days = _args3.length > 0 && _args3[0] !== undefined ? _args3[0] : 30;
        ...
        case 5:
          historyItems = _context3.sent;
          _context3.next = 8;
          return storeHistoryItems(historyItems);
        case 8:
          // Fetch and store visit details for each URL
          _iterator = _createForOfIteratorHelper(historyItems);
          _context3.prev = 9;
          _iterator.s();
        case 11:
        ...
        case 15:
          visits = _context3.sent;
          _context3.next = 18;
          return storeVisitDetails(item.url, visits);
        case 18:
          _context3.next = 11;
          break;
        case 20:
        ...
        case 28:
          console.log("Successfully fetched and stored history for the past ".concat(days, " days"));
          _context3.next = 34;
          break;
        case 31:
          _context3.prev = 31;
          _context3.t1 = _context3["catch"](2);
          console.error('Error fetching or storing history:', _context3.t1);
        case 34:
        case "end":
          return _context3.stop();
      }
    }, _callee3, null, [[2, 31], [9, 22, 25, 28]]);
  }));
  return _fetchAndStoreHistory.apply(this, arguments);
}
function getHistoryFromDB(_x4) {
  return _getHistoryFromDB.apply(this, arguments);
} // Similarly modify getMostVisitedFromDB to include timing metrics
function _getHistoryFromDB() {
  _getHistoryFromDB = datahandlers_asyncToGenerator(/*#__PURE__*/datahandlers_regeneratorRuntime().mark(function _callee4(days) {
    var startTime, startDbTime, stats, fromCache, startTimeMs, transaction, historyStore, index, range, requestPromise, results, apiStartTime, historyItems, _iterator2, _step2, item, visits, apiEndTime, endTime;
    return datahandlers_regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          startTime = performance.now();
          startDbTime = performance.now();
          stats = {
            dbTime: 0,
            apiTime: 0,
            fromCache: true
          ...
          fromCache = true;
          startTimeMs = Date.now() - days * 24 * 60 * 60 * 1000;
          _context4.prev = 5;
          // Try to get from IndexedDB first s
          transaction = db.transaction(['historyItems'], 'readonly');
          historyStore = transaction.objectStore('historyItems');
          index = historyStore.index('lastVisitTime');
          range = IDBKeyRange.lowerBound(startTimeMs);
        ...
        case 13:
          ...
          fromCache = false;
          apiStartTime = performance.now(); // Get from Firefox History API
          _context4.next = 19;
          return browser.history.search({
            text: '',
        ...
        case 19:
          historyItems = _context4.sent;
          _context4.next = 22;
          return storeHistoryItems(historyItems);
        case 22:
          // Get visit details for each URL
          _iterator2 = _createForOfIteratorHelper(historyItems);
          _context4.prev = 23;
          _iterator2.s();
        case 25:
        ...
        case 50:
          ...
          console.error('Error in getHistoryFromDB:', _context4.t1);
          throw _context4.t1;
        case 54:
        case "end":
          return _context4.stop();
      }
    }, _callee4, null, [[5, 50], [23, 36, 39, 42]]);
  }));
  return _getHistoryFromDB.apply(this, arguments);
}
function getMostVisitedFromDB(_x5) {
  return _getMostVisitedFromDB.apply(this, arguments);
} // Similarly modify getVisitDetailsFromDB
function _getMostVisitedFromDB() {
  _getMostVisitedFromDB = datahandlers_asyncToGenerator(/*#__PURE__*/datahandlers_regeneratorRuntime().mark(function _callee5(days) {
    var limit,
      startTime,
      startDbTime,
      stats,
      ...
      endTime,
      _args6 = arguments;
    return datahandlers_regeneratorRuntime().wrap(function _callee5$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          transaction = db.transaction(['visitDetails'], 'readonly');
          visitsStore = transaction.objectStore('visitDetails');
          index = visitsStore.index('visitTime');
          range = IDBKeyRange.lowerBound(startTimeMs);
          requestPromise = new Promise(function (resolve, reject) {
            var request = index.getAll(range);
            request.onsuccess = function () {
        ...
        case 20:
          historyItems = _context6.sent;
          // Process each item
          visits = [];
          _iterator3 = _createForOfIteratorHelper(historyItems);
          _context6.prev = 23;
          _loop = /*#__PURE__*/datahandlers_regeneratorRuntime().mark(function _loop() {
            var _visits;
            var item, itemVisits;
            return datahandlers_regeneratorRuntime().wrap(function _loop$(_context5) {
              while (1) switch (_context5.prev = _context5.next) {
                ...
                case 3:
                  itemVisits = _context5.sent;
                  (_visits = visits).push.apply(_visits, _toConsumableArray(itemVisits.map(function (v) {
                  ...
                  // Store for next time
                  _context5.next = 7;
                  return storeHistoryItems([item]);
                case 7:
                  _context5.next = 9;
                  return storeVisitDetails(item.url, itemVisits);
                case 9:
                case "end":
        ...
        case 26:
          ...
          return _context6.delegateYield(_loop(), "t0", 28);
        case 28:
          _context6.next = 26;
          break;
        case 30:
        ...
        case 40:
          ...
          visits.forEach(function (visit) {
            try {
              var domain = extractDomain(visit.url);
          ...
          sortedDomains = Array.from(domainCounts).sort(function (a, b) {
            return b[1] - a[1];
        ...
        case 48:
          ...
          console.error('Error in getMostVisitedFromDB:', _context6.t2);
          throw _context6.t2;
        case 52:
        case "end":
          return _context6.stop();
      }
    }, _callee5, null, [[6, 48], [23, 32, 35, 38]]);
  }));
  return _getMostVisitedFromDB.apply(this, arguments);
}
function getVisitDetailsFromDB(_x6) {
  return _getVisitDetailsFromDB.apply(this, arguments);
} // Store category for a URL
function _getVisitDetailsFromDB() {
  _getVisitDetailsFromDB = datahandlers_asyncToGenerator(/*#__PURE__*/datahandlers_regeneratorRuntime().mark(function _callee6(url) {
    var startTime, startDbTime, stats, fromCache, transaction, visitsStore, index, requestPromise, results, apiStartTime, visits, apiEndTime, endTime;
    return datahandlers_regeneratorRuntime().wrap(function _callee6$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          transaction = db.transaction(['visitDetails'], 'readonly');
          visitsStore = transaction.objectStore('visitDetails');
          index = visitsStore.index('url');
          requestPromise = new Promise(function (resolve, reject) {
            var request = index.getAll(url);
            request.onsuccess = function () {
              var dbEndTime = performance.now();
              stats.dbTime = (dbEndTime - startDbTime) / 1000;
              resolve(request.result);
        ...
        case 17:
          visits = _context7.sent;
          _context7.next = 20;
          return storeVisitDetails(url, visits);
        case 20:
          results = visits;
          apiEndTime = performance.now();
          stats.apiTime = (apiEndTime - apiStartTime) / 1000;
        ...
        case 28:
          ...
          console.error('Error in getVisitDetailsFromDB:', _context7.t0);
          throw _context7.t0;
        case 32:
        case "end":
...
function storeCategory(_x7, _x8) {
  return _storeCategory.apply(this, arguments);
} // Get category for a URL
function _storeCategory() {
  _storeCategory = datahandlers_asyncToGenerator(/*#__PURE__*/datahandlers_regeneratorRuntime().mark(function _callee7(url, category) {
    return datahandlers_regeneratorRuntime().wrap(function _callee7$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        case 0:
          return _context8.abrupt("return", new Promise(function (resolve, reject) {
            ...
            var request = categoriesStore.put({
              url: url,
              category: category
            });
            request.onsuccess = function () {
...
function getCategoryFromDB(_x9) {
  return _getCategoryFromDB.apply(this, arguments);
}
function _getCategoryFromDB() {
  _getCategoryFromDB = datahandlers_asyncToGenerator(/*#__PURE__*/datahandlers_regeneratorRuntime().mark(function _callee8(url) {
    return datahandlers_regeneratorRuntime().wrap(function _callee8$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          return _context9.abrupt("return", new Promise(function (resolve, reject) {
            var transaction = db.transaction(['categories'], 'readonly');
            var categoriesStore = transaction.objectStore('categories');
            var request = categoriesStore.get(url);
            request.onsuccess = function () {
...
function background_regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ background_regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == background_typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator["return"] && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(background_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, "catch": function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
...
browser.history.onVisited.addListener(/*#__PURE__*/function () {
  var _ref = background_asyncToGenerator(/*#__PURE__*/background_regeneratorRuntime().mark(function _callee(historyItem) {
    var visits;
    return background_regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0,datahandlers_namespaceObject.storeHistoryItems)([historyItem]);
        case 3:
          _context.next = 5;
          return browser.history.getVisits({
            url: historyItem.url
        ...
        case 5:
          ...
          _context.next = 8;
          return (0,datahandlers_namespaceObject.storeVisitDetails)(historyItem.url, visits);
        case 8:
          console.log("Updated database with new visit: ".concat(historyItem.url));
          _context.next = 14;
          break;
        case 11:
          _context.prev = 11;
          _context.t0 = _context["catch"](0);
          console.error('Error handling history event:', _context.t0);
        case 14:
        case "end":
          return _context.stop();
      }
...
browser.runtime.onMessage.addListener(function (message, sender, sendResponse) {
  if (message.action === 'getHistory') {
    (0,datahandlers_namespaceObject.getHistoryFromDB)(message.days).then(function (result) {
      return sendResponse({
        success: true,
        data: result.data,
        stats: result.stats
    ...
    (0,datahandlers_namespaceObject.getVisitDetailsFromDB)(message.url).then(function (result) {
      return sendResponse({
        success: true,
        data: result.data,
        stats: result.stats
    ...
    (0,datahandlers_namespaceObject.getMostVisitedFromDB)(message.days, message.limit).then(function (result) {
      return sendResponse({
        success: true,
        data: result.data,
        stats: result.stats
    ...
    (0,datahandlers_namespaceObject.getMostVisitedFromDB)(message.days || 30, message.limit || 10).then(function (result) {
      return sendResponse({
        success: true,
        data: result.data
      });
...
initDB().then(function () {
  ...
  return (0,datahandlers_namespaceObject.fetchAndStoreHistory)(30); // Fetch past 30 days by default
}).then(function () {
